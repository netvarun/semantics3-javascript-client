...
},{}],"MsW3Vt":[function(require,module,exports){
...
module.exports = function (options,req_param,req_endpoint,headers) {
    ...
    if ((_ref2 = options.path) == null) {
        options.path='/sign';
    }
    if ((_ref3 = options.method) == null) {
        options.method = 'POST';
    }
    if ((_ref4 = req_param) == null) {
        req_param = 'q';
    }
    if ((_ref5 = req_endpoint) == null) {
        req_endpoint = 'e';
    }

    var userAgent = 'Semantics3 JSClient Lib/' + VERSION;
    ...
    function _request( endpoint, data, callback) {
        var data_params = {};
        data_params[req_param] = {};
        data_params[req_param] = data;
        data_params[req_endpoint] = endpoint;
        var post_data = qs.stringify(data_params);

        customHeaders['Content-Length'] = post_data.length;
        ...
        products: {
                ...
                run_query: function(endpoint) {
                    ...
                    if(arguments.length == 2) {
                        _request(endpoint,data_query[endpoint],callback);
                    }
                    else {
                        var data = arguments[1];
                        if(typeof data === 'string') {
                            _request(endpoint,JSON.parse(data),callback);
                        }
                        else if(typeof data === 'object') {
                            _request(endpoint,data,callback);
                        }
                        else {
...
},{"http":6,"qs":1}],3:[function(require,module,exports){
...
},{"__browserify_process":25}],4:[function(require,module,exports){
...
},{"./lib/request":7,"events":3}],7:[function(require,module,exports){
...
},{"./response":8,"Base64":9,"concat-stream":10,"stream":4}],8:[function(require,module,exports){
var Stream = require('stream');
...
},{"bops":11,"stream":4,"util":5}],11:[function(require,module,exports){
var proto = {}
...
},{"./copy.js":16,"./create.js":17,"./from.js":18,"./is.js":19,"./join.js":20,"./read.js":22,"./subarray.js":23,"./to.js":24,"./write.js":14}],12:[function(require,module,exports){
(function (exports) {
	'use strict';
...
},{"./mapped.js":21}],"./semantics3-js-client":[function(require,module,exports){
module.exports=require('MsW3Vt');
...
},{"base64-js":12}],19:[function(require,module,exports){
...
},{"base64-js":12,"to-utf8":13}],25:[function(require,module,exports){
